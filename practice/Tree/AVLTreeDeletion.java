...
class AVLTreeDeletion {
			...
			public static void main(String args[]) {							
					...
					System.out.print("\nEnter a value from the above list to delete : ");
					
					Scanner dv = new Scanner(System.in);
					int d = dv.nextInt();

					Node nR = deleteNode(r, r, d);

					if(nR != null) { System.out.print("\nValues in the tree after deleting " + d + " are : "); preorderTraverse(nR); }
			}
			...
			public static Node deleteNode(Node r, Node mR, int v) {

					Node n = searchAVL(r, v);
					if(n == null) { System.out.println("Given node value does not exist in the tree "); return mR; }
					else if(n == mR && n.right == null && n.left == null) { System.out.println("After deleting node value, there are no nodes in the tree"); return null; }

					else if(n.right == null && n.left == null) {
						if(n.parent.right != null && n.parent.right == n) { 
							n.parent.right = null; 
							updateHeight(n.parent); 
							mR = afterDeletion(n.parent, mR, mR); 
							n.parent = null; 
							return mR; 
						}
						...
						if(n.parent != null && n.parent.right == n) {
							if(n.right.ht >= n.left.ht) {
								r = getSuccessor(n.right);
								if(r != n.right && r.right != null) {
									r.right.parent = r.parent;
									r.parent.left = r.right;
									r.parent = n.parent; r.left = n.left; r.right = n.right;
									r.parent.right = r; r.left.parent = r; r.right.parent = r;
									n.parent = null; n.left = null; n.right = null;
									r = getSuccessor(r.right);
									updateHeight(r.parent);
									mR = afterDeletion(r.parent, mR, mR);
									return mR;
								}

								else if(r != n.right && r.right == null) {									
									r.parent.left = null;
									r.parent = n.parent; r.left = n.left; r.right = n.right;
									r.parent.right = r; r.left.parent = r; r.right.parent = r;
									n.parent = null; n.left = null; n.right = null;
									r = getSuccessor(r.right);
									updateHeight(r);
									mR = afterDeletion(r, r, mR);
									return mR;
								}

								else {									
									r.parent = n.parent; r.left = n.left;
									r.parent.right = r; r.left.parent = r;
									n.parent = null; n.left = null; n.right = null;									
									updateHeight(r);
									mR = afterDeletion(r, r, mR);
									return mR;
								...
								r = getPredecessor(n.left);
								if(r != n.left && r.left != null) {
									r.left.parent = r.parent;
									r.parent.right = r.left;
									r.parent = n.parent; r.left = n.left; r.right = n.right;
									r.parent.right = r; r.left.parent = r; r.right.parent = r;
									n.parent = null; n.left = null; n.right = null;
									r = getSuccessor(r.left);
									updateHeight(r.parent);
									mR = afterDeletion(r.parent, mR, mR);
									return mR;
								}

								else if(r != n.left && r.left == null) {									
									r.parent.right = null;
									r.parent = n.parent; r.left = n.left; r.right = n.right;
									r.parent.right = r; r.left.parent = r; r.right.parent = r;
									n.parent = null; n.left = null; n.right = null;
									...
									r.parent = n.parent; r.right = n.right;
									r.parent.right = r; r.right.parent = r;
									n.parent = null; n.left = null; n.right = null;									
									updateHeight(r);
									mR = afterDeletion(r, r, mR);
									return mR;
							...
							if(n.right.ht >= n.left.ht) {
								...
								if(r != n.right && r.right != null) {
									...
									r.parent.left = r.right;
									r.parent = n.parent; r.left = n.left; r.right = n.right;
									r.parent.left = r; r.left.parent = r; r.right.parent = r;
									n.parent = null; n.left = null; n.right = null;
									r = getSuccessor(r.right);
									updateHeight(r.parent);
									mR = afterDeletion(r.parent, mR, mR);
									...
									r.parent = n.parent; r.left = n.left;
									r.parent.left = r; r.left.parent = r;
									n.parent = null; n.left = null; n.right = null;									
									updateHeight(r);
									mR = afterDeletion(r, r, mR);
									return mR;
								...
								if(r != n.left && r.left != null) {
									...
									r.parent = n.parent; r.right = n.right;
									r.parent.left = r; r.right.parent = r;
									n.parent = null; n.left = null; n.right = null;									
									updateHeight(r);
									mR = afterDeletion(r, r, mR);
									return mR;
							...
							if(n.right.ht >= n.left.ht) {
								...
								if(r != n.right && r.right != null) {
									...
									n.parent = null; n.left = null; n.right = null;
									mR = getSuccessor(r.right);
									updateHeight(mR.parent);
									mR = afterDeletion(mR.parent, r, r);
									return mR;
								}
			...
			public static Node searchAVL(Node r, int v) {

					if(r == null) return null;
					else if(r.val == v) return r;
					else if(r.val > v) return searchAVL(r.left, v);
					else return searchAVL(r.right, v);
			}

			public static Node afterDeletion(Node r, Node t, Node mR) {

					if(r == null) return mR;
					else {
						t = checkBalance(r);						
						if(t != null) { mR = rebalance(t, mR); return afterDeletion(r.parent, mR, mR); }
						else return afterDeletion(r.parent, mR, mR); 
					}
			}

			public static Node getPredecessor(Node r) {

					if(r.right == null) return r;
					else return getPredecessor(r.right);
			}

			public static Node getSuccessor(Node r) {

					if(r.left == null) return r;
					else return getSuccessor(r.left);
			}
